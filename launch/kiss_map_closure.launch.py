...
def launch_setup(context, *args, **kwargs):
    ...
    mc_config_path  = os.path.join(pkg_share, 'config', 'kiss_map_closure_rov.yaml')
    ...
    return [
        ...
        #### KISS-ICP + MapClosures odometry ####
        Node(
            package='sonar_localization',
            executable='kiss_map_closure',
            name='kiss_mc_node',
            output='screen',
            parameters=[mc_config_path, {'use_sim_time': True}],
        ),
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument(
            'full_bag', default_value='true',
            description='true = full bag initial pose, false = cropped bag initial pose'),
