...
private:
    ...
    {
        if (s == "ICP")            return RegMethod::ICP;
        if (s == "PointToPlane")   return RegMethod::POINT_TO_PLANE;
        if (s == "GICP")           return RegMethod::GICP;
        if (s == "NDT")            return RegMethod::NDT;
        return RegMethod::VGICP;   // default
    }
